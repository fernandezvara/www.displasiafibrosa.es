...
categories:
    ...
    questions:
      - q: "¿Qué es la Displasia Fibrosa?"
        a: |
          ...
          La mayoría de las personas con DF (70% aprox.) sólo tienen un hueso afectado, lo cual se denomina **DF Monostótica**. Cuando la DF afecta a más de un hueso, se denomina **DF Poliostótica**.

      - q: "¿Qué es el Síndrome de McCune-Albright?"
        a: |
      ...
      - q: "¿Cuáles son los síntomas de la Displasia Fibrosa y del Síndrome de McCune-Albright?"
        a: |
      ...
      - q: "¿Cómo es de frecuente la Displasia Fibrosa y el Síndrome de McCune-Albright en la población?"
        a: |
      ...
      - q: "¿Qué huesos suelen afectarse con mayor frecuencia en la Displasia Fibrosa?"
        a: |
      ...
      - q: "¿Pueden aparecer nuevas lesiones después de los 15 años?"
        a: |
  ...
  - name: "Diagnóstico y Tratamiento"
    questions:
      - q: "¿Se hereda la Displasia Fibrosa y el Síndrome de McCune-Albright?"
        a: |
          La Displasia Fibrosa y el Síndrome de McCune-Albright **NO son hereditarios**. No se hereda de los padres ni se transmite a los hijos.
      ...
      - q: "Mi médico se ha referido a la Displasia Fibrosa como tumor del hueso. ¿Padezco cáncer o puede volverse maligna?"
        a: |
          ...
          Por normal general, se necesitan muchas mutaciones en una misma célula para que se genere un tumor maligno (cáncer). La mutación causante de la DF/MAS se ha encontrado en algunos tumores malignos de la glándula pituitaria (o hipófisis) y menos frecuentemente, en otros tipos de cáncer. Como la mayoría de pacientes con DF/MAS no desarrollan estos tumores malignos, no parece que la mutación de la DF de lugar a cáncer por sí misma.

          Es cierto que una lesión de DF puede malignizarse y volverse cancerosa, pero esto ocurre excepcionalmente afectando a menos de un 1% de los pacientes con la enfermedad.
      - q: "El médico me ha dicho que la Displasia Fibrosa mejorará después de la adolescencia. ¿Es esto cierto?"
        a: |
      ...
      - q: "Siento dolor en los huesos afectados con DF, pero mi médico me ha dicho que la DF no duele. ¿Es esto cierto?"
        a: |
      ...
      - q: "¿Existe una cura definitiva para la Displasia Fibrosa y el Síndrome de McCune-Albright?"
        a: |
      ...
      - q: "¿Qué médicos son los más adecuados para manejar esta enfermedad?"
        a: |
          ...
          - Anestesista (manejo del dolor)

          Alteraciones endocrinas (metabolismo/hormonas, salud reproductiva)
          - Endocrinólogo
          - Ginecólogo
      ...
      - q: "¿En qué momento se deben consultar a los médicos especialistas?"
        a: |
      ...
      - q: "¿Qué investigaciones se están llevando a cabo para la displasia fibrosa?"
        a: |
          ...
          - "Mechanistic and Therapeutic Studies of Fibrous Dysplasia in a New Mouse Model." Dr. Yingzi Yang of Harvard School of Dental Medicine, of Boston
      ...
      - q: "¿Qué pruebas se realizan más comúnmente para la displasia fibrosa y el Síndrome de McCune-Albright?"
        a: |
          ...
          Para más información consulte nuestra traducción de [Guías Médicas](https://displasiafibrosa.es/descargar-guia-medica/).

      - q: "¿Cómo pueden las personas con DF/MAS tratar y manejar el dolor?"
        a: |
          ...
          Debido a que la DF es una enfermedad crónica, los fármacos opiáceos a largo plazo deben ser evitados en la medida de lo posible, pero si fueran necesarios deben ser prescritos por un especialista como parte de una clínica del dolor (generalmente un anestesista).

      - q: "¿Cómo pueden las personas con DF/MAS retrasar el crecimiento de las lesiones óseas?"
        a: |
          ...
          El exceso de hormona de crecimiento no controlado aumenta el crecimiento de la DF cráneo-facial, por lo que es muy importante evaluar y tratar a los pacientes.

  - name: "Vida Diaria y Apoyo"
    questions:
      - q: "¿Cómo va afectar a mi vida la Displasia Fibrosa?"
        a: |
      ...
      - q: "¿Qué tipo de seguimiento médico necesito?"
        a: |
          El seguimiento médico depende del tipo y extensión de la enfermedad. Generalmente se recomienda:

          - **Revisión ortopédica**: Cada 6-12 meses para evaluar el estado óseo
          - **Análisis hormonales**: Anualmente si hay afectación endocrina
          - **Pruebas de imagen**: Según la localización y evolución de las lesiones
          - **Valoración del dolor**: Regularmente para ajustar tratamientos

          Es importante seguir las recomendaciones de tu equipo médico especializado.

      - q: "¿La DF o MAS causan problemas en el embarazo? ¿Hay que tomar precauciones especiales?"
        a: |
          Muchas mujeres con DF/MAS tienen embarazos exitosos. No hay evidencia de que el embarazo haga que la DF empeore o aumente el dolor óseo. Las mujeres con DF en la columna, las costillas o la pelvis deben realizar un seguimiento con un obstetra especializado en embarazos de alto riesgo.
      ...
      - q: "¿Pueden las personas con DF participar en actividades físicas incluyendo deportes de contacto, o deben evitarlas?"
        a: |
      ...
      - q: "¿La DF craneofacial presenta riesgos en el cerebro?"
        a: |
...
{{< alert type="success" >}}
Este texto se ha elaborado a partir de la información obtenida y con el permiso de la <a href="https://www.fibrousdysplasia.org">Fundación de Displasia Fibrosa de EEUU</a>
{{< /alert >}}
